        ...
        <footer className="bg-gray-200">
            <section className="flex justify-center items-center container mx-auto py-6">
                <div className="w-1/3">
                    ...
                    <p>Specializers in providing high-quality, stylish products for your wardrobe</p>
                </div>
